...
from ashishk3s_ashish_prophecy_snowflake_word_count_test.tasks import (
    CheckCustomerData,
    CustomerData,
...
with DAG(
    dag_id = "ashishk3s_ashish_prophecy_snowflake_word_count_test", 
    ...
    SFTPToSnowflakeOperator_1_op >> CustomerData_op
